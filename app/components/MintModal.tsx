        ...
        <div className="px-5 pt-5 pb-6">
          ...
          {!isConnected ? (
            <Wallet className="w-full flex justify-center">
              <ConnectWallet
                disconnectedLabel="Connect Wallet to Pay"
                className="w-full min-w-0 rounded-md btn-primary text-white text-base font-bold leading-[140%] transition-colors active:scale-[0.98] flex items-center justify-center gap-2 h-[46px] font-['Satoshi',sans-serif]"
              />
              <WalletDropdown>
                <WalletDropdownDisconnect />
              </WalletDropdown>
            ...
            <>
              <div className="w-full mb-2 flex justify-center">
                <Wallet className="w-full flex justify-center">
                  <ConnectWallet
                    disconnectedLabel="Switch Wallet"
                    className="w-full min-w-0 text-center text-xs text-gray-500 underline mb-2 bg-transparent border-0 p-0 cursor-pointer font-inherit shadow-none hover:bg-transparent hover:shadow-none"
                  />
                  <WalletDropdown>
                    <WalletDropdownDisconnect />
                  </WalletDropdown>
